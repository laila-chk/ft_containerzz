...
namespace ft {
	...
	template <> struct is_integral<const char16_t> {
		static const bool value = true;
	};

	template <> struct is_integral<const char32_t> {
		static const bool value = true;
	};
	...
	template <> struct is_integral<const volatile char16_t> {
		static const bool value = true;
	};

	template <> struct is_integral<const volatile char32_t> {
		static const bool value = true;
	};
	...
	template <> struct is_integral<const volatile short int> {
		static const bool value = true;
	};
	...
	template <> struct is_integral<const volatile long int> {
		static const bool value = true;
	};
	template <> struct is_integral<const volatile long long int> {
		static const bool value = true;
	};
	...
	template <> struct is_integral<const volatile unsigned short int> {
		static const bool value = true;
	};
	...
	template <> struct is_integral<const volatile unsigned long int> {
		static const bool value = true;
	};
	...
	template <> struct is_integral<volatile char16_t> {
		static const bool value = true;
	};

	template <> struct is_integral<volatile char32_t> {
		static const bool value = true;
	};
	...
	template <> struct is_integral<volatile short int> {
		static const bool value = true;
	};
	...
	template <> struct is_integral<volatile long int> {
		static const bool value = true;
	};
	template <> struct is_integral<volatile long long int> {
		static const bool value = true;
	};
	...
	template <> struct is_integral<volatile unsigned short int> {
		static const bool value = true;
	};
	...
	template <> struct is_integral<volatile unsigned long int> {
		static const bool value = true;
	};
	/***************************************************{enable if}*******************************************************/
